...
import de.zet_evakuierung.model.RoomImpl;
...
public class RoomConverter extends PlanPolygonConverter {
	...
	/**
	 * Checks whether an object is of the type {@link de.zet_evakuierung.model.Room} and thus can be
	...
	/**
	 * Allows reading an {@link de.zet_evakuierung.model.Room} class. Due to format extensions,
