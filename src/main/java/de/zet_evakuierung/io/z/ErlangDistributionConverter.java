 ...
 */
package de.zet_evakuierung.io.z;
...
/**
 * A converter that allows to load and store {@link ErlangDistribution} objects. It loads the parameters of the
 * distribution as xml-attributes.
 *
...
public class ErlangDistributionConverter implements Converter {
    ...
    /**
     * <p>
     * Checks wheather an object can be converted by this class, that is if it is of the type
     * {@link ErlangDistribution}</p> {@inheritDoc}
     *
    ...
    /**
     * <p>
     * Writes the attributes of the {@link ErlangDistribution} to the xml tag. Written attributes are min, max, lambda
     * and k.</p> {@inheritDoc}
     *
    ...
    public void marshal(Object source, HierarchicalStreamWriter writer, MarshallingContext context) {
        ...
        writer.addAttribute("min", dist.getMin().toString());
        writer.addAttribute("max", dist.getMax().toString());
        writer.addAttribute("lambda", Double.toString(dist.getLambda()));
        writer.addAttribute("k", Integer.toString(dist.getK()));
    }

    /**
     * <p>
     * Reads the attributes of an {@link ErlangDistribution} and creates the object instance. Readed attributes are min,
     * max lambda and k.</p>
     * {inheritDoc}
     *
