...
public class Person {
	...
	private de.tu_berlin.coga.zet.model.SaveArea saveArea;
	...
	public Person( PlanPoint position, Room room ) throws IllegalArgumentException {
		if( !room.getPolygon().contains( position ) ) {
			throw new IllegalArgumentException( ZLocalization.loc.getString( "ds.z.NoPersonException" ) );
		}
	...
	public void setDiameter( double diameter ) throws java.lang.IllegalArgumentException {
		if( diameter <= 0 )
			throw new java.lang.IllegalArgumentException( ZLocalization.loc.getString( "ds.z.DiameterException" ) );
	...
	public void setAge( double age ) throws java.lang.IllegalArgumentException {
		if( age < 0 )
			throw new java.lang.IllegalArgumentException( ZLocalization.loc.getString( "ds.z.AgeException" ) );
		this.age = age;
	}
	...
	public void setFamiliarity( double familiarity ) throws java.lang.IllegalArgumentException {
		if( familiarity <= 0 )
			throw new java.lang.IllegalArgumentException( ZLocalization.loc.getString( "ds.z.FamilarityException" ) );
	...
	public void setPanic( double panic ) throws java.lang.IllegalArgumentException {
		if( panic < 0 )
			throw new java.lang.IllegalArgumentException( ZLocalization.loc.getString( "ds.z.PanicException" ) );
		this.panic = panic;
	}
	...
	public void setDecisiveness( double decisiveness ) throws java.lang.IllegalArgumentException {
		if( decisiveness <= 0 )
			throw new java.lang.IllegalArgumentException( ZLocalization.loc.getString( "ds.z.DecisivenessException" ) );
	...
	public void setReaction( double reaction ) throws java.lang.IllegalArgumentException {
		if( reaction < 0 )
			throw new java.lang.IllegalArgumentException( ZLocalization.loc.getString( "ds.z.ReactionException" ) );
