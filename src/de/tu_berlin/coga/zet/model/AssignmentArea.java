...
public class AssignmentArea extends AreaImpl {
	@XStreamAsAttribute()
	 ...
	 */
	AssignmentArea( RoomImpl room, AssignmentType type ) {
	 ...
	 * (Number is set to 0.)
	 */
	AssignmentArea( RoomImpl room, AssignmentType type, int evacuees) throws IllegalArgumentException {
		super( room, AreaType.Assignment );
	 ...
	 */
	@Override
	public PlanPolygon<PlanEdge> splitClosedPolygon (PlanEdge edge1, PlanEdge edge2) throws IllegalArgumentException {
	 ...
	 * (Number is set to 0.)
	 */
	public final void setEvacuees (int val) throws IllegalArgumentException {
		if (val<0) {
	...
	public void setAssignmentType (AssignmentType val) throws NullPointerException {
		if( val == null ) throw new NullPointerException ( loc.getString("ds.z.AssignmentArea.NoAssignmentTypeException") );
...
// TODO: warum das hier und wenn nötig, text schreiben!
	 ...
	 * @throws PolygonNotClosedException If the area is not closed.
	 * @throws TooManyPeopleException If the assignmentArea contains too many persons.
	...
	private void checkTooManyPersonsInArea() throws TooManyPeopleException {
		if( getEvacuees() != 0 && (area() / getEvacuees() < Assignment.spacePerPerson) )
			throw new TooManyPeopleException( this, loc.getString( "ds.z.AssignmentArea.ContainsToManyPersonsException" ) );
	}
