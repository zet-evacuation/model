...
/**
 * A {@code DefaultEvacuationFloor} basically behaves as a normal {@link Floor}.
 * It can create automatically designed "evacuation rooms" that are rooms containing only
 * one evacuation area that are connected to another floor with an {@link TeleportEdge}.
...
public class DefaultEvacuationFloor extends Floor {
	...
	public void addEvacuationRoom( RoomEdge sourceEdge ) {
		...
		ArrayList<PlanPoint> points = new ArrayList<>( 6 );
		points.add( ul );
		points.add( ur );
