...
/**
 * Represents a delayArea. This type of area has an speedFactor, which has an
 * influence on the speed of the evacuees in this area. Every delayArea is
 * associated to exactly one {@link Room} at every time.
 */
...
public class DelayArea extends AreaImpl {
	...
	/**
	 * Returns the currently set value for the speedFactor. The speedfactor is the
	 * percentage of the original speed that can be achieved on this area. A
	 * speedfactor of 1 would be normal speed and speedfactor of 0 would mean
	 * total halt.
	 *
	 * @return speedFactor
	 */
	...
	/**
	 * <p>
	 * Sets a new value for the speedFactor in the area. The speedfactor is the
	 * percentage of the original speed that can be achieved on this area. A
	 * speedfactor of 1 would be normal speed and speedfactor of 0 would mean
	 * total halt.</p>
	 * <p>
	 ...
	 *
	 * @throws java.lang.IllegalArgumentException the speedFactor must be greater
	 * than 0.
